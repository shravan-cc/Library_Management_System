...
async function initializeDb() {
  ...
  await migrate(drizzle(migrationClient), {
    migrationsFolder:
      'C:/Users/shravantr/Documents/assignmentprime/Library_Management/Library_Management_System/drizzle/migrations', // Adjust this path to your migrations folder
  });
